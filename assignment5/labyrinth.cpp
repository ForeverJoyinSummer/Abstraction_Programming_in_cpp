 ...
 */
const string kYourName = "Summer";

/* Change this constant to the path out of your labyrinth. */
const string kPathOutOfNormalMaze = "EESSSNNNWWWSSEESNWSW";
 ...
 */
MazeCell* moveTo(MazeCell* current, char dir) {
    if (dir == 'E') {
        return current->east;
    }
    else if (dir == 'W') {
        ...
        error("There is not such a character!");
    }
}
